# Generated by Django 4.2.1 on 2024-10-21 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Minimum 5 characters'), django.core.validators.MaxLengthValidator(100, message='Maximum 100 characters')], verbose_name='Slug')),
